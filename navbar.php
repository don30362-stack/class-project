<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><img src="product_img/logo-s.png" class="img-fluid" alt="logo" style="max-width: 120px;"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="d-flex justify-content-center" role="search">
                ...
                <button class="btn" type="button" data-bs-toggle="collapse" data-bs-target="#searchBar"><i class="fa-solid fa-magnifying-glass"></i></button>
            </form>
                ...
                <li class="nav-item dropend">
                    ...
                    <ul class="dropdown-menu submenu">
                        <?php while ($pyclass02_rows = $pyclass02->fetch()) { ?>
                            <li><a href="#" class="dropdown-item"><em class="fas <?= $pyclass02_rows['fonticon']; ?> fa-fw"></em><?= $pyclass02_rows['cname']; ?></a></li>
                        <?php } ?>
                    </ul>
